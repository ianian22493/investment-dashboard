...
def build_fk_html(district, analysis, date_str, period_num):
    ...
    parts.append(
        ...
        f'    </div>\n'
        f'    <script>\n'
        f'    window.__fkCharts = window.__fkCharts || {{}};\n'
        f'    window.__fkCharts["{chart_trend_id}"] = {{\n'
        f'      type: "line",\n'
        ...
        f'    }};\n'
        f'    window.__fkCharts["{chart_spot_id}"] = {{\n'
        f'      type: "bar",\n'
        ...
        f'    }};\n'
        f'    (function(){{\n'
        f'      ["{chart_trend_id}", "{chart_spot_id}"].forEach(function(id) {{\n'
        f'        var c = document.getElementById(id);\n'
        f'        if (c && !Chart.getChart(c)) new Chart(c, window.__fkCharts[id]);\n'
        f'      }});\n'
        f'    }})();\n'
        f'    </script>\n'
    )
